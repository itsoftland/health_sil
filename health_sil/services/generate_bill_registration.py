...
def create_registration_only(patient, patient_name, items=None, mode_of_payment=None):
    """
    Creates a Sales Invoice for patient registration and auto-generates Payment Entry.
    ...
    try:
        ...
        invoice = create_and_submit_invoice_only(patient, patient_name, customer, items, original_user)
...
def create_and_submit_invoice_only(patient, patient_name, customer, items, original_user):
